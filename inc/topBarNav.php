...
<!-- Navbar -->
      <style>
       ...
       <nav class="w-100 px-2 py-1 position-fixed top-0 bg-gradient-teal text-light" id="login-nav">
      ...
      <nav class="main-header navbar navbar-expand navbar-light border-0 text-sm" id='top-Nav'>
        ...
        <div class="container">
          <a href="./" class="navbar-brand">
            <h6>Dr.Mahalingam College Of Engineering And Technology</h6>
           <!-- <img src="<?php echo validate_image($_settings->info('logo'))?>" alt="Site Logo" class="brand-image img-rectangle elevation-3" style="opacity: ;height:55px;">-->
