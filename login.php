...
<body class="hold-transition ">
  ...
  <?php endif;?>
  <div class="h-100 d-flex align-items-center w-200" id="login">
    <div class="col-5 h-200 d-flex align-items-center justify-content-center">
      <div class="w-100">
        1<!--<center><img src="<?= validate_image($_settings->info('logo')) ?>" alt="" id="logo-img"></center>-->
        ...
        <div class="card col-sm-12 col-md-6 col-lg-3 card-outline card-teal rounded-0 shadow">
          ...
          <div class="card-body rounded-0">
            <form id="client-login-frm" action="" method="post">
              ...
              <div class="row">
                <div class="col-8">
                  <a href="<?php echo base_url.'register.php' ?>" class="text-teal">Create an Account</a>
                </div>
                <!-- /.col -->
                <div class="col-4">
                  <button type="submit" class="btn btn-default border-0 bg-gradient-teal btn-block btn-flat">Sign In</button>
                </div>
                <!-- /.col -->
              </div>
            </form>
