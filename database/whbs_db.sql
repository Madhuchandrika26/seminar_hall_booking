...
INSERT INTO `booking_list` (`id`, `code`, `client_id`, `hall_id`, `services_ids`, `Hall_schedule`, `total_guests`, `remarks`, `status`, `date_created`, `date_updated`) VALUES
...
INSERT INTO `hall_list` (`id`, `code`, `name`, `image_path`, `status`, `delete_flag`, `date_created`, `date_updated`) VALUES
(1, 'Hall-102', 'Seminar Hall 2', 'it was in 4th floor', NULL, 1, 0, '2022-01-31 10:10:16', NULL),
(2, 'Hall-102', 'Seminar Hall 1', 'it was in 4th floor', NULL, 1, 0, '2022-01-31 10:10:16', NULL);
...
(1, 'name', 'Seminar Hall Booking System'),
(6, 'short_name', 'sHBS - PHP'),
