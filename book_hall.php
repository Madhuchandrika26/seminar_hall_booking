    ...
    <form action="" id="book-form">
        ...
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <input type="date" id="wedding_schedule" name="wedding_schedule" value="<?= isset($event_schedule) ? $event_schedule : "" ?>" class="form-control form-control-sm form-control-border" required>
            </div>
            <div class="col-md-6 form-group">
        ...
        <div class="row">
            <div class="col-md-12 form-group">
                <label for="remarks" class="control-label">Purpose</label>
