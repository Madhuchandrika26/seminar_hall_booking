  ...
  <div class="h-100 d-flex align-items-center w-100" id="login">
    <div class="col-4 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
        ...
        <h6 class="text-center py-5 login-title"><b><?php echo $_settings->info('name') ?></b></h6>
      </div>
      
    </div>
    <div class="col-5 h-100  ">
      <div class="d-flex w-100 h-100 justify-content-center align-items-center">
        <div class="card col-lg-12 card-outline card-teal rounded-0 shadow">
            ...
            <form id="register-frm" action="" method="post">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <small class="ml-3 text-teal">First Name</small>
                </div>
                <div class="form-group col-md-6">
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <small class="ml-3 text-teal">Gender</small>
                </div>
                <div class="col-md-6">
                  <input type="text" name="contact" id="contact" class="form-control form-control-sm form-control-border" required>
                  <small class="ml-3 text-teal">Contact #</small>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <small class="ml-3 text-teal">Department</small>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <small class="ml-3 text-teal">Email</small>
                </div>
              </div>
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <small class="ml-3 text-teal">Password</small>
                </div>
                <div class="form-group col-md-6">
                  <div class="input-group input-group-sm">
                  ...
                  <small class="ml-3 text-teal">Confirm Password</small>
                </div>
              </div>
              <div class="row">
                <div class="col-8">
                  <a href="<?php echo base_url.'login.php' ?>" class="text-teal">Already have an Account</a>
                </div>
                <!-- /.col -->
                <div class="col-4">
                  <button type="submit" class="btn btn-default bg-gradient-teal border-0 btn-block btn-flat">Create Account</button>
                </div>
                <!-- /.col -->
              </div>
            </form>
