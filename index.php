...
<?php require_once('inc/header.php') ?>
        ...
        <?php if($page == "home" || $page == "about_us"): ?>
          <div id="header" class="shadow mb-4">
              <div class="d-flex justify-content-center h-100 w-100 align-items-center flex-column px-3">
                  ...
                  <button class="btn btn-lg btn-default bg-gradient-teal border-0 rounded-pill px-4 w-25" id="book_now">Book Now</button>
  ...
  <div class="modal fade rounded-0" id="uni_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default btn-flat bg-gradient-teal" id='submit' onclick="$('#uni_modal form').submit()">Save</button>
  ...
  <div class="modal fade rounded-0" id="confirm_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default btn-flat bg-gradient-teal" id='confirm' onclick="">Continue</button>
      ...
      <script>
        $(function(){
          ...
          $(window).scroll(function(){
            ...
            if($('#header').length > 0){
              if ($(this).scrollTop()  <= 0 ){
                  $('#top-Nav').removeClass('bg-light text-teal')
                              .addClass('bg-transparent')
              }else{
                  $('#top-Nav').addClass('bg-light text-teal')
