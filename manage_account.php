        ...
        <div class="card card-outline card-teal rounded-0 shadow">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a class="btn btn-default border-0 bg-gradient-teal btn-flat" href="./?page=manage_account">Update Account</a>
                </div>
            </div>
            <div class="card-body">
                <div class="container-fluid">
                    <form id="client-form" action="" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                            <small class="ml-3 text-teal">Address</small>
                        ...
                        <div class="row">
                            ...
                            <small class="ml-3 text-teal">New Password</small>
                            </div>
                            <div class="form-group col-md-6">
                            <div class="input-group input-group-sm">
                            ...
                            <small class="ml-3 text-teal">Confirm New Password</small>
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <small class="ml-3 text-teal">Image</small>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <small class="ml-3 text-teal">Current Password</small><br>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-8">
                            ...
                            <!-- /.col -->
                            <div class="col-4">
                            <button type="submit" class="btn btn-default bg-gradient-teal border-0 btn-block btn-flat">Update Account</button>
                            </div>
                            <!-- /.col -->
                        </div>
                        </form>
