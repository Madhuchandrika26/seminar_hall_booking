        ...
        <div class="card col-sm-12 col-md-6 col-lg-3 card-outline card-teal rounded-0 shadow">
          ...
          <div class="card-body rounded-0">
            <form id="login-frm" action="" method="post">
              ...
              <div class="row">
                <div class="col-8">
                  <a href="<?php echo base_url ?>" class="text-teal">Go to Website</a>
                </div>
                <!-- /.col -->
                <div class="col-4">
                  <button type="submit" class="btn btn-default bg-gradient-teal border-0 btn-block btn-flat">Sign In</button>
                </div>
                <!-- /.col -->
              </div>
            </form>
