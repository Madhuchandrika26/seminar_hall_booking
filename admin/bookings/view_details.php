...
<div class="container-fluid">
    <div id="outprint" class="list-group">
        <div class="row">
            <div class="col-4 bg-gradient-teal border">Reference Code:</div>
            <div class="col-8 text-dark border"><?= isset($code) ? $code : "N/A" ?></div>
            <div class="col-4 bg-gradient-teal border">Client Name:</div>
            <div class="col-8 text-dark border"><?= isset($fullname) ? $fullname : "N/A" ?></div>
            <div class="col-4 bg-gradient-teal border">Contact #:</div>
            <div class="col-8 text-dark border"><?= isset($contact) ? $contact : "N/A" ?></div>
            <div class="col-4 bg-gradient-teal border">Address:</div>
            <div class="col-8 text-dark border"><?= isset($address) ? $address : "N/A" ?></div>
            <div class="col-4 bg-gradient-teal border">Hall:</div>
            <div class="col-8 text-dark border"><?= isset($hall) ? $hall : "N/A" ?></div>
            <div class="col-4 bg-gradient-teal border">Services:</div>
            <div class="col-8 text-dark border"><?= isset($services) ? $services : "N/A" ?></div>
            <div class="col-4 bg-gradient-teal border">Event Schedule:</div>
            <div class="col-8 text-dark border"><?= isset($event_schedule) ? date("M d, Y", strtotime($event_schedule)) : "N/A" ?></div>
            <div class="col-4 bg-gradient-teal border">Total Guests:</div>
            <div class="col-8 text-dark border"><?= isset($total_guests) ? $total_guests : "N/A" ?></div>
            <div class="col-4 bg-gradient-teal border">Status:</div>
            ...
            <div class="col-4 bg-gradient-teal border">Remarks:</div>
